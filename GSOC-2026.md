...
Thanks to Joshua Hodge of The Audio Programmer for his excellent series on (building a DJ application in C++ with JUCE)[https://www.youtube.com/watch?v=HzinVwqrB-A&list=PLLgJJsrdwhPy_P0ooNLRxT2kOITqHMhw0]. It was the clearest reference I found for how the pieces of a DJ app fit together — deck, transport, waveform, playlist — and the JUCE AudioThumbnail design it walks through is what DJAudioThumbnail is modelled on.
