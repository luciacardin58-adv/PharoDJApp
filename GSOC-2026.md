...
| Repository | Role | Commits | Range |
|---|---|---|---|
| [PharoDJApp](https://github.com/luciacardin58-adv/PharoDJApp) | Composition root + baseline | 7 | <!-- FIRST_SHA...LAST_SHA --> |
| [DjBlocUI](https://github.com/luciacardin58-adv/DjBlocUI) | Bloc/Toplo user interface | 62 | <!-- FIRST_SHA...LAST_SHA --> |
| [DJAudio-Formats](https://github.com/luciacardin58-adv/DJAudio-Formats) | WAV/AIFF parsing, thumbnails | 23 | <!-- FIRST_SHA...LAST_SHA --> |
| [DJDeck](https://github.com/luciacardin58-adv/DJDeck) | Phausto DSP, player, cues | 14 | <!-- FIRST_SHA...LAST_SHA --> |
| [DJCrateBrowser](https://github.com/luciacardin58-adv/DJCrateBrowser) | Spec 2.0 prototype (see §3) | 18 | <!-- FIRST_SHA...LAST_SHA --> |

> Replace each placeholder with a GitHub compare link of the form
> `https://github.com/<owner>/<repo>/compare/<first-sha>...<last-sha>` so the
> full change log, diff and commit list open in one click.

**Final GSoC commit:** <!-- SHA + DATE -->. Work continues on this codebase
...
124 commits over 11 weeks. All test suites are green.
...
Stated plainly, because the next person to touch this needs to know.
...
Thanks to <!-- MENTORS --> for review and direction throughout, and to the
CoypuIDE and Toplo maintainers for responding to bug reports and API questions
